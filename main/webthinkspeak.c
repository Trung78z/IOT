...
static void http_get_task(void *pvParameters)
{
    ...
    while (1)
    {
        esp_rom_gpio_pad_select_gpio(PIN_IN);
        gpio_set_direction(PIN_IN, GPIO_MODE_INPUT);
        DHT11_init(PIN_IN);
        struct dht11_reading reading = DHT11_read();
        int a = reading.temperature;
        int b = reading.humidity;
        ...
        sprintf(REQUEST, "GET https://api.thingspeak.com/update?api_key=QPOS5APHMPJNA24L&field1=%d&field2=%d\n\n", a, b);
        freeaddrinfo(res);
